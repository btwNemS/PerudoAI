...
class Partie { //AB
	...
	public function __construct($J1, $J2, $J3, $J4){
			...
			for ($j=0;$j<4;$j++){
				...
				$this->joueurs[$j]=new $classeAappeler($classeAappeler); //appelle les constructeurs $J1 $J2... ce qui signifie que les arguments du constructeur doivent être écrits exactement comme le nom des classes (casse incluse)
			}
    ...
    */
	...
	//jouer
		...
		//APPELER ICI LES METHODES QUIAPRES ET QUIAVANT
                ...
                fwrite($fichier, '['.$joueurQuiJoue.','.$reponseJoueur[0].','.$reponseJoueur[1].']');
